    ...
    <ul class="navbar-nav upper-nav-list navbar-links w-100 bg-danger mr-auto">
        ...
        <section class="content ">
            <div class="container mt-5">
                <h1 class="text-center mt-5 mb-5 font-weight-bold">Welcome to Smart Shopping</h1>
                ...
                <div class="row">
                    ...
                    <a href="product details.php" class="d-block text-decoration-none text-dark w-100">
                        <div class="card">
                            <img src="products/remote-robot.webp" class="card-img-top" alt="Remote Robot">
                            <div class="card-body">
                                <h5 class="card-title">Remote Robot</h5>
                                <p class="card-text">Explore and have fun with our innovative remote-controlled robot.</p>
                            </div>
                        </div>
    </a>
                    </div>
                    ...
                    <a href="product details.php" class="d-block text-decoration-none text-dark w-100">
                        <div class="card">
                            <img src="products/laptop.webp" class="card-img-top" alt="Laptop">
                            <div class="card-body">
                                <h5 class="card-title">Laptop</h5>
                                <p class="card-text">Boost your productivity with our high-performance laptops.</p>
                            </div>
                        </div>
    </a>
                    </div>
                    ...
                    <a href="product details.php" class="d-block text-decoration-none text-dark w-100">
                        <div class="card">
                            <img src="products/smartphone.webp" class="card-img-top" alt="Smartphone">
                            <div class="card-body">
                                <h5 class="card-title">Smartphone</h5>
                                <p class="card-text">Experience the latest technology with our feature-packed smartphones.</p>
                            </div>
                        </div>
    </a>
                    </div>
